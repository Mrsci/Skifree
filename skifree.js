...
var SKI = (function() {
    ...
    var User = function() {
        ...
        /**
         * Update the user's movement based on touch position.
         * @param {Object} event
         */
        function touchMove(event) {
			...
			// Get the location of the mouse
			// Firefox doesn't have event offsetX/Y so we need to calc it.
			if (typeof event.changedTouches[0].offsetX === 'undefined') {
				mouseX = event.changedTouches[0].pageX - event.changedTouches[0].target.offsetLeft;
				mouseY = event.changedTouches[0].pageY - event.changedTouches[0].target.offsetTop;
			} else {
    ...
    var Game = (function() {
        ...
        function init() {
            ...
            canvas.addEventListener('touchmove', user.touchMove, true);
